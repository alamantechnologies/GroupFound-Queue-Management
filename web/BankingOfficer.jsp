        ...
        <div class="container-fluid" id="bbk"  >
                    ...
                    <hr>
                     ...
                     <div class="servidesk">
                         ...
                         <h1 class="text-center spn">View Service Desk</h1>
                    ...
                    <hr>
                    <h1 class="text-center post-tittle spn">View Ticket Details</h1>
                    <hr>
            ...
            <div class="form-group " >
                 ...
                 <div class="col-md-3"><button class="btn-success ">send</button></div>
                 <div class="col-md-3" style="margin-left: 10px;"><button class="btn-success ">edit</button></div>
            </div>
             </form>
